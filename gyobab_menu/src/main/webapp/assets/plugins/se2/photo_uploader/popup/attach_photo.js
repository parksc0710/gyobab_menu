    ...
    function html5Upload() {	
    	...
    	sUploadURL= '${pageContext.request.contextPath}/main/multiImageUploader.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/multiImageUploader.do',	//샘플 URL입니다.
 	        sCallback : '/assets/plugins/se2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
